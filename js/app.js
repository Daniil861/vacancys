(() => {
    ...
    (() => {
        ...
        function menuInit() {
            if (document.querySelector(".menu")) if (innerWidth > 1024) {
                document.querySelector(".menu").addEventListener("mouseenter", (function(e) {
                    if (bodyLockStatus && !document.documentElement.classList.contains("menu-open")) {
                        bodyLockToggle(0);
                ...
                if (bodyLockStatus && (e.target.closest(".icon-menu") || e.target.closest(".menu__close768"))) {
                    bodyLockToggle(0);
        ...
        if (document.querySelector(".menu-header") && document.querySelector('[data-btn="services"]') && !document.documentElement.classList.contains("menu-open")) document.querySelector('[data-btn="services"]').addEventListener("click", (() => {
            document.documentElement.classList.add("menu-open");
        }));
        window["FLS"] = false;
        isWebp();
